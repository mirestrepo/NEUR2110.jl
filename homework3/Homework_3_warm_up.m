...
cd('C:\Dropbox\workDocs\Teaching\NEUR2110_Statistical_Neuroscience_Fall_2017\Homework_3_Lect_5&6\')
path(path,'C:\Dropbox\workDocs\Teaching\NEUR2110_Statistical_Neuroscience_Fall_2017\Homework_2_Lect_3&4\') %multitaperSpectrum
...
SIGMA =diag([0.6;0.5; 0.3; 0.3; 0.6]);
mu = zeros(xDim,1);
for r=1:nTrials
    r
